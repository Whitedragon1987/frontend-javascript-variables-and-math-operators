...
// ==========================================
const dividedMultiply = 36 / 6 * 2;
console.log(dividedMultiply);
...
const village = "Heinkenszand";
const province = "Zeeland";
const location = village + ", " + province;
